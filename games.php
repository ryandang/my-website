...
$(document).ready(function() {
				$("#project$x").css("top", "200px");
				$("#project$x").css("opacity", "0");
				setTimeout(function(){
					
				    
					//$("#project$x .pic").animate({top: "0px"},1000);
					$("#project$x").animate({opacity: "1", top: "0px"},1000);
				},$animatetime);	
});
</script>
HTML;
...
?>
	...
	<div class="project_name" ><h2> Puzzle Game </h2></div>
	<div class='focus grow pic'>
		<a href="./assembling_game/puzzle"><img src="images/puzzle_game.jpg" alt="" width="250" height="250"></a>
	</div>
	</div>

	<div id="project2" class="project_container">
	<div class="project_name" ><h2> Hangman Game </h2></div>
	<div class='focus grow pic'>
	...
	<div class="project_name" ><h2> Deal or No Deal </h2></div>
	<div class='focus grow pic'>
	...
	<div class="project_name" ><h2> Math Game </h2></div>
	<div class='focus grow pic'>
	...
	<div class="project_name" ><h2> Mr&Ms Ashbridges </h2></div>
	<div class='focus grow pic'>
