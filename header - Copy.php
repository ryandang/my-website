...
<script type='text/javascript' src='<?php echo BASE_URL; ?>js/jquery-ui-1.8.18.custom.js'></script>
...
<li class="menu-1-portfolio <?php if($page == "aboutme.php") echo "active" ?>">
<a href="<?php echo BASE_URL; ?>aboutme">FBI</a>
</li>
<li class="menu-2-cv <?php if($page == "works.php") echo "active" ?>">
<a href="<?php echo BASE_URL; ?>works">MyWork</a>
</li>
<!--
...
-->
<li class="<?php if($page == "games.php" || $page == "assembling_game/puzzle.php") echo "active" ?>" style="margin-left: 240px;">
...
<img id="me" src ="<?php echo BASE_URL; ?>images/me.png" alt="Ryan"/>
